    ...
    <section className="py-20 px-4 bg-gradient-to-b from-white to-gray-100">
      <div className="container mx-auto max-w-4xl text-center">
        ...
        <a href="https://calendar.app.google/gzKyuKMMiJdvN1fz9" target="_blank" rel="noopener noreferrer">
          <Button className="bg-brand-orange hover:bg-brand-blue text-white text-lg px-6 py-5 rounded-md shadow-lg transition-all w-full md:w-auto whitespace-normal">
            Beratungsgespräch<br className="hidden sm:block" /> vereinbaren
          </Button>
        </a>
      </div>
    </section>

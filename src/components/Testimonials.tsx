...
const TestimonialCard = ({ name, title, company, content, imagePath }: TestimonialProps) => {
  return (
    <div className="bg-white p-8 rounded-xl shadow-md border border-gray-100 flex flex-col items-center">
      <div className="mb-6 flex flex-col items-center">
        <div className="h-20 w-20 rounded-full overflow-hidden mb-4 border-2 border-brand-orange">
          {imagePath ? (
            ...
            <div className="w-full h-full bg-brand-blue/10 flex items-center justify-center">
              <span className="text-2xl font-semibold text-brand-blue">{name.charAt(0)}</span>
            </div>
          )}
        </div>
      ...
      <p className="text-gray-700 mb-6 text-center leading-relaxed">"{content}"</p>
    ...
    <section id="testimonials" className="py-20 px-4 bg-gray-50">
      <div className="container mx-auto">
        <div className="text-center mb-12">
          <p className="text-brand-orange uppercase font-semibold tracking-wider mb-3">Erfahrungen</p>
          <h2 className="text-3xl md:text-4xl font-bold text-brand-blue">Und das sagen unsere Mitglieder</h2>

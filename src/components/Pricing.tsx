        ...
        <div className="max-w-4xl mx-auto text-center space-y-8">
          <div className="space-y-4">
            <p className="text-xl text-gray-700">
              Egal, für welches Paket Du Dich entscheidest: Du investierst in
              eine nachhaltige Transformation mit messbaren Ergebnissen, baust
              wertvolles internes Know-how auf und profitierst von der
              Sicherheit unseres Garantieversprechens und der Kraft unserer
              Community.
            </p>

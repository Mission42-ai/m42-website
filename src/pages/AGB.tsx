    ...
    <div className="min-h-screen bg-white flex flex-col">
      ...
      <div className="container mx-auto py-24 flex-grow px-4 md:px-6">
        <div className="max-w-3xl mx-auto prose prose-headings:text-brand-blue prose-a:text-brand-orange">
          ...
          <p>für die Erbringung von Dienstleistungen von Konstantin Kalheber, Boxhagener Str. 33, 10245 Berlin, E-Mail: konstantin@mission42.ai (nachfolgend „Auftragnehmer") gegenüber seinen Kunden (nachfolgend „Auftraggeber")</p>
          ...
          <p>Die Mission42 Community bietet praxisorientierte Bildungs- und Unterstützungsprogramme zur Einführung und Nutzung von Künstlicher Intelligenz (KI) in Unternehmen an. Zu den Leistungen zählen Self-Paced Learning Tracks, regelmäßige Live-Sessions mit Experten und der Zugriff auf exklusive Ressourcen zur Implementierung von KI-Lösungen. Die spezifischen Programme, KI-Executive Class und KI-Champion Class, vermitteln Kenntnisse und Fähigkeiten zur strategischen Entwicklung, Implementierung und Anwendung von KI-Technologien mittels No-Code-Tools. Darüber hinaus umfasst das Angebot den Zugang zu einer Online-Community mit Expertenaustausch, einer KI-Agenten-Bibliothek sowie begleitenden Live-Q&A-Sessions.</p>
